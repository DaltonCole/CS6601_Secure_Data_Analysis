...
def main():
    ...
    os.system("./runCircuit "+sys.argv[1]+" ./"+outFileName +" ./"+ outInputFileName +" ./"+ outInput2FileName)
    #subprocess.call(["./runCircuit",sys.argv[1]+" ./"+outFileName +" ./"+ outInputFileName +" ./"+ outInput2FileName])
